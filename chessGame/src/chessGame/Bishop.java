...
public class Bishop extends ChessPiece {
	...
	public Bishop(String side, int row, int col, ChessBoard chessBoard, JPanel boards[][], JButton movepins[][],
		...
		white_icon = new ImageIcon("image/Bishop-white.png");
		white_icon.setDescription("white_icon");

		black_icon_select = new ImageIcon("image/Bishop-black_s.png");
		black_icon_select.setDescription("black_icon_select");

		white_icon_select = new ImageIcon("image/Bishop-white_s.png");
		white_icon_select.setDescription("white_icon_select");

		black_icon_attack = new ImageIcon("image/Bishop-black_a.png");
		black_icon_attack.setDescription("black_icon_attack");

		white_icon_attack = new ImageIcon("image/Bishop-white_a.png");
